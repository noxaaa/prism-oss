...
import { Card, CardAction, CardContent, CardHeader, CardTitle } from "@noxaaa/prism-oss-web-core/ui/card";
import { Field, FieldLabel } from "@noxaaa/prism-oss-web-core/ui/field";
import { Input } from "@noxaaa/prism-oss-web-core/ui/input";
import { Sheet, SheetContent, SheetHeader, SheetTitle } from "@noxaaa/prism-oss-web-core/ui/sheet";
...
import { DataState, EnumSelect, FieldRequirementBadge, PageStack, StatusBadge, SummaryCard, SummaryGrid, TableSkeleton, useControlList } from "@noxaaa/prism-oss-web-core/console/shared";
import type { DNSCredential, DNSInstance, DNSManagedRecord, NotificationChannel, ResourceOption } from "@noxaaa/prism-oss-web-core/console/types";
