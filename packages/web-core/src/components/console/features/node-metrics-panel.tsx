...
import { Progress } from "@noxaaa/prism-oss-web-core/ui/progress";
...
import { bytes, formatBitrateBps, shortDate } from "@noxaaa/prism-oss-web-core/console/control-api";
import { useI18n } from "@noxaaa/prism-oss-web-core/console/i18n";
import { StatusBadge, duration, percent } from "@noxaaa/prism-oss-web-core/console/shared";
import type { AgentMetrics, NodeResource } from "@noxaaa/prism-oss-web-core/console/types";
