...
import { bytes, controlDelete, controlGet, controlPatch, controlPost, formatBitrateBps, shortDate } from "@noxaaa/prism-oss-web-core/console/control-api";
import { localizeControlError, localizeEnum, localizeImportIssue, useI18n } from "@noxaaa/prism-oss-web-core/console/i18n";
import { hasAnyPermission, hasPermission } from "@noxaaa/prism-oss-web-core/console/permissions";
import { ResourceSelect } from "@noxaaa/prism-oss-web-core/console/resource-select";
import { RuleDeploymentCell, RuleDeploymentSummary } from "@noxaaa/prism-oss-web-core/console/rule-deployment-ui";
import { RuleMatchCell } from "@noxaaa/prism-oss-web-core/console/rule-match-cell";
import { RuleMutationForm, formatPortSegments } from "@noxaaa/prism-oss-web-core/console/features/rule-mutation-form";
import { RuleUpstreamCell } from "@noxaaa/prism-oss-web-core/console/rule-upstream-cell";
...
import type { ResourceOption, Rule, RuleBatchResult, RuleDiagnostics, RuleExportPayload, RuleImportRequest, RuleImportResult, RuleTraffic, Target, TargetGroup } from "@noxaaa/prism-oss-web-core/console/types";
