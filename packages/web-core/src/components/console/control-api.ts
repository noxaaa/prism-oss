...
import type { APIEnvelope, ResourceOption } from "@noxaaa/prism-oss-web-core/console/types";
import { formatMessage, type Locale } from "@noxaaa/prism-oss-web-core/console/i18n-core";
